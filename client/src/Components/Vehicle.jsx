    ...
    return (
        ...
        <div className='w-screen h-screen bg-page_background'>
          ...
          <div className='flex-1 flex items-center space-x-4 justify-end'>
            ...
            {/* info del historial */}
            <div className='bg-tabla_service bottom-2 border-gris-footer items-center lg:h-info_history h-info_history_2 lg:mr-marg-5 mr-marg-1 lg:ml-marg-4 ml-marg-1 mt-marg-3 flex flex-wrap rounded-lg justify-items-center justify-center shadow-md shadow-gray-300 h-30'>
