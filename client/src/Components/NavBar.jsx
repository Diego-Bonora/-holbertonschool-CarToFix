    ...
    <header>
      <div className=" py-1 pr-14 pl-8 bg-cian-oscuro md:rounded-b-header_border flex items-center justify-between">
        ...
        ${menuOpen ? 'block' : 'hidden'}`}>
          <Link to='/vehiculo' className='w-40 md:bg-azul-oscuro inline-block rounded text-center py-2 text-white md:text-sm md:font-medium md:shadow-[0_4px_9px_-4px_#3b71ca] md:hover:bg-shadow_header md:hover:text-white'>Vehículos</Link>
          <Link to='/vehicle' className='w-40 md:bg-azul-oscuro inline-block rounded text-center text-white py-2 md:text-sm font-medium md:shadow-[0_4px_9px_-4px_#3b71ca] md:hover:bg-shadow_header md:hover:text-white'>Presupuestos</Link>
          <Link to='/Service' className='w-40 md:bg-azul-oscuro inline-block rounded text-center text-white py-2 md:text-sm font-medium md:shadow-[0_4px_9px_-4px_#3b71ca] md:hover:bg-shadow_header md:hover:text-white'>Servicios</Link>
        </nav>        
          </div>
    </header>
  )
